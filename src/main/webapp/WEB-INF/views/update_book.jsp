...
<body style="background-color: #B0BCEB">
    <div class="container mt-5">
        <div class="card" style="width: 25rem">
            <div class="card-body">
                <h5 class="card-title" align="center" >Edit Book</h5>
                <f:form modelAttribute="book" action="/library/update" method="post">
                    <f:hidden path="id"/>
                    ...
                    <div class="form-group mt-2 ">
                        <center><input type="submit" value="Update Book" class="btn btn-warning"></center>
                    </div>
